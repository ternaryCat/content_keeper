  ...
  module Tags
    class DetachTagsListAnswer < BaseAnswer
      ...
      def multi_page_list_response
        ...
        controller.respond_with :message, text: I18n.t('bot.tag.detach', count: count),
      ...
      def next_arrow
        button I18n.t('bot.keyboard.next'), 'detach_tags_list', mode: :edit, next_id: next_id, content_id: content_id
      end
